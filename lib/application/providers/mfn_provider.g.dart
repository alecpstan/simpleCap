...
String _$mfnMutationsHash() => r'aef7dfe3a011fa0d41a8eb02d61d4de51ceea7a6';

/// Notifier for MFN upgrade mutations.
///
/// Copied from [MfnMutations].
@ProviderFor(MfnMutations)
final mfnMutationsProvider =
    AutoDisposeAsyncNotifierProvider<MfnMutations, void>.internal(
      MfnMutations.new,
      name: r'mfnMutationsProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$mfnMutationsHash,
      dependencies: null,
...
typedef _$MfnMutations = AutoDisposeAsyncNotifier<void>;
