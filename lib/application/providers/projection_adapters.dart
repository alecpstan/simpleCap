...
Convertible _convertibleFromState(ConvertibleState state, String companyId) {
  return Convertible(
    ...
    notes: state.notes,
    maturityBehavior: state.maturityBehavior,
    allowsVoluntaryConversion: state.allowsVoluntaryConversion,
    liquidityEventBehavior: state.liquidityEventBehavior,
    liquidityPayoutMultiple: state.liquidityPayoutMultiple,
    dissolutionBehavior: state.dissolutionBehavior,
    preferredShareClassId: state.preferredShareClassId,
    qualifiedFinancingThreshold: state.qualifiedFinancingThreshold,
    createdAt: state.createdAt,
    updatedAt: state.updatedAt,
  );
}
