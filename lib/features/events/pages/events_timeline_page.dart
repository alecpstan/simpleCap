...
import '../../core/pages/transaction_editor.dart';
...
class _EventsTimelinePageState extends State<EventsTimelinePage> {
  ...
  List<TimelineEvent> _buildEvents(CoreCapTableProvider provider) {
  ...
  Widget _buildEventCard(TimelineEvent event, CoreCapTableProvider provider) {
  ...
  void _showEventDetails(TimelineEvent event, CoreCapTableProvider provider) {
