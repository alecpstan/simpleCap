...
import 'ownership_pie_chart.dart';
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget _buildHeader(BuildContext context, CoreCapTableProvider provider) {
  ...
  Widget _buildStatsGrid(BuildContext context, CoreCapTableProvider provider) {
